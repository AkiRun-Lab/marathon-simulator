# MPC 自動起動（Keep Alive）マニュアル

## 概要

マラソンペース計算ツール（MPC）は Streamlit Community Cloud の無料プランで動いています。
...
[https://github.com/AkiRun-Lab/marathon-simulator](https://github.com/AkiRun-Lab/marathon-simulator) にアクセス。
...
左側のサイドバーに「**Keep Alive - MPC (Marathon Pace Calculator)**」が表示されます。クリックしてください。
...
実行行をクリック → 「**wake-up**」ジョブ → 「**Wake up MPC App**」ステップを開くと詳細ログが見えます。
...
1. [Actions タブ](https://github.com/AkiRun-Lab/marathon-simulator/actions/workflows/keep-alive.yml) を開く
